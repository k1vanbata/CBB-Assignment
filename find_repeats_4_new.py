...
def read_dna_sequence_from_file(file_path, num_genes):     
    sequence = ""   
    count = 0
...
def process_dna_file_parallel(file_path, output_file, num_genes, num_processes=4):
    ...
    dna_sequence = read_dna_sequence_from_file(file_path, num_genes)
...
if __name__ == '__main__':
    ...
    file_path = "D:/abroad/Duke/CBB520/S288c_DNA"  # Update this with the actual file path

    output_file = 'D:/abroad/Duke/CBB520/repeat_analysis_output.txt'  # Update with desired output file path
